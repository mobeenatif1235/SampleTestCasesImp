...
WebUI.waitForElementVisible(findTestObject('Object Repository/Product notification call/bell hit area'), 30)


WebUI.click(findTestObject('Object Repository/Product notification call/bell hit area'))
